...
function AddVillager() {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("Submitting form with data:", {
      name, gender, number, line1, line2, division
    });
    try {
                      ...
                      <form onSubmit={handleSubmit}>
                        <div className="row">
                          <div className="mb-3 col-md-6">
                            ...
                            <input className="form-control" id="name" value={name} onChange={(e) => setName(e.target.value)} required />
                          </div>
                          <div className="mb-3 col-md-6">
                        ...
                        <div className="row">
                          <div className="mb-3 col-md-6">
                            <label htmlFor="number" className="form-label">Address Number</label>
                          ...
                          <div className="mb-3 col-md-6">
                            ...
                            <input type="text" className="form-control" id="line1" value={line1} onChange={(e) => setLine1(e.target.value)} required />
                          </div>
                        </div>
                        ...
                        <div className="row">
                          <div className="mb-3 col-md-6">
                            ...
                            <input type="text" className="form-control" id="line2" value={line2} onChange={(e) => setLine2(e.target.value)} required />
                          </div>
                          <div className="mb-3 col-md-6">
                            <label htmlFor="division" className="form-label">Division</label>
                            <select className="form-control" id="division" value={division} onChange={(e) => setDivision(e.target.value)} required>
                              <option value="">-Select-</option>
                        ...
                        <div className="card-footer d-flex justify-content-center mt-2">
                          <button type="submit" className="btn btn-primary col-sm-12 mt-3 col-md-6" disabled={submit}>Submit</button>
                        </div>
                      </form>
                    </div>
                  </div>
